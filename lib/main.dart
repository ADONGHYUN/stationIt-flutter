...
class _HomeScreenState extends State<HomeScreen> {
  String _nearestStationName = "위치 확인 중..."; // _stationName -> _nearestStationName
  ...
  Future<void> _findNearestStation() async {
    ...
    try {
      ...
      Position position = await Geolocator.getCurrentPosition(
          desiredAccuracy: LocationAccuracy.medium); // 정확도 설정
      ...
      final Uri uri = Uri.parse('$apiUrl?lat=${position.latitude}&lon=${position.longitude}');
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('서버에서 응답을 받지 못했습니다. (Status code: ${response.statusCode})');
      }
    } catch (e) {
      // 5. 에러 처리
      setState(() {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              // 새로고침 버튼
              ElevatedButton.icon(
                onPressed: _isLoading ? null : _findNearestStation, // 로딩 중에는 비활성화
